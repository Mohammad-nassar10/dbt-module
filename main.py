from module.utils import get_details_from_conf
import yaml
import os
...
if __name__ == "__main__":
    ...
    conf, adapter_host, adapter_port = get_details_from_conf("sample-conf.yaml")
    ...
    with open("dbt/models/view.sql", "w+") as model_file:
    ...
    with open("dbt/models/schema1.yml", "w+") as model_schema:
        l1 = "version: 2"
        l2 = "models:"
        l3 = "  - name: custview"
    ...
    os.system("python3.8 dbt/dbt-rpc/dbt_rpc/__main__.py serve")